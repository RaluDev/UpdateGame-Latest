//parcurgerea array-ului de jocuri cu promise
...
function updateDomElement(gameElement) {
    ...
    // updateGameRequest cu promise
    updateGameRequest(gameElement.id, urlencoded).then(createDomElement);
